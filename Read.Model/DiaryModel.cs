...
namespace Read.Model
{
    public class DiaryModel
    {
        ...
        public DiaryModel(Guid id, string openid, string nickname, string createtime, string modifytime, int disabled,string diarycontent,string city,string weather)
        {
            this._id = id;
            this._openid = openid;
